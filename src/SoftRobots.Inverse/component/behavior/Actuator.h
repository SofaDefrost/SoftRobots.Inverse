...
class Actuator : virtual public softrobots::behavior::SoftRobotsConstraint<DataTypes>
{
public:

    SOFA_CLASS(SOFA_TEMPLATE(Actuator,DataTypes), SOFA_TEMPLATE(softrobots::behavior::SoftRobotsConstraint,DataTypes));

    Actuator(sofa::core::behavior::MechanicalState<DataTypes> *mm = nullptr);
    ~Actuator() override;
    ...
    using softrobots::behavior::SoftRobotsBaseConstraint::ACTUATOR ;
    using softrobots::behavior::SoftRobotsBaseConstraint::m_nbLines ;
    ////////////////////////////////////////////////////////////////////////////

    void storeResults(sofa::type::vector<double> &lambda, sofa::type::vector<double> &delta) override;

protected:

    sofa::Data<bool>  d_applyForce;
};
