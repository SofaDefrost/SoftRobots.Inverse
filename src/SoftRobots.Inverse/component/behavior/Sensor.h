...
class Sensor : virtual public softrobots::behavior::SoftRobotsConstraint<DataTypes>
{
public:

    SOFA_CLASS(SOFA_TEMPLATE(Sensor,DataTypes), softrobots::behavior::SoftRobotsConstraint<DataTypes>);

    Sensor(sofa::core::behavior::MechanicalState<DataTypes> *mm = nullptr);
    ~Sensor() override;
    ...
    using softrobots::behavior::SoftRobotsBaseConstraint::SENSOR ;
    ////////////////////////////////////////////////////////////////////////////
